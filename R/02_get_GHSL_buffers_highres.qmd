...
Now that the table is created, we can increment through the various buffer sizes using a loop (this is not optimized or parallelized, and takes up to a few hours on a laptop):
